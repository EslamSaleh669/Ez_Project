package com.example.ezproject.data.firebasemsgs
...
class MyFirebaseMessagingService : FirebaseMessagingService() {
    ...
    private fun sendNotification(messageBody: String , messagetitle: String) {
        ...
        if (messagetitle.equals("Unit") || messagetitle.equals("Booking")){
            intent.putExtra("titlekey",1)
        }else{
            intent.putExtra("titlekey",2)
        }
        ...
        val notificationBuilder = NotificationCompat.Builder(this, channelId)
            .setSmallIcon(R.drawable.ic_ezuru_luancher)
